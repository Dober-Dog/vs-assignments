...
// console.log("There are " + computers + " computers in the office.")
...
// let lightCondition = 0
// const lightSwitch = [9, 3, 4, 2]

// for(i = 0; i < lightSwitch.length; i++){
//     lightCondition = lightCondition + lightSwitch[i]
// }

// if(lightCondition % 2 == 0){
